(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=nc';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_93c7a5bcc61cf0e23e5f22d91bdf93295b3f75e737d635f064fef63faecd861d";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/nc-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/nc-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/nc-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=nc" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=nc" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
    ...
    function init() {
        ...
        const NC_STORE_WHATSAPP = '556299101220';
        function showLimitWhatsApp() {
            ...
            if (link) {
                ...
                link.href = 'https://wa.me/' + NC_STORE_WHATSAPP + '?text=' + encodeURIComponent(msg);
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'nc', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL NC Conceito] Enviando', allProdImgs.length, 'fotos do produto');
